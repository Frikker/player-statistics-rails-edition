...
TeamMatch.create!(team: Team.find(1), opponent_team: Team.find(2), date: Date.parse('29/05/2019'))
TeamMatch.create!(team: Team.find(1), opponent_team: Team.find(3), date: Date.parse('31/05/2019'))
TeamMatch.create!(team: Team.find(1), opponent_team: Team.find(4), date: Date.parse('27/05/2019'))
TeamMatch.create!(team: Team.find(2), opponent_team: Team.find(3), date: Date.parse('28/05/2019'))
TeamMatch.create!(team: Team.find(2), opponent_team: Team.find(4), date: Date.parse('30/05/2019'))
TeamMatch.create!(team: Team.find(3), opponent_team: Team.find(4), date: Date.parse('31/05/2019'))

Player.find_each do |player|
  (TeamMatch.where(team: player.team) + TeamMatch.where(opponent_team: player.team)).each do |match|
